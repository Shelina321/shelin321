        ...
        <div class="col d-flex justify-content-center">
          <div class="">
            ...
            <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['user_id'])) : ?>
              ...
              <a href="registervisitor.php" class="btn btn-outline-dark">Visitor<i class='bx bx-user-plus' ></i></a>
              <a href="register.php" class="btn btn-outline-dark">User<i class='bx bx-log-in'></i></i></a>
              <?php endif ; ?>
