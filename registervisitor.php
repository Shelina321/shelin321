...
if (isset($_POST['username'])) {
    ...
    if ($query) {
        echo '<script>alert("Register berhasil, silahkan login"); location.href ="loginvisitor.php"</script>';
    } else {
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div>
              <p class="mb-0">Already have an account? <a href="loginvisitor.php" class="text-white-50 fw-bold">Login!</a>
              </p>
            </div>
            </form>
          </div>
